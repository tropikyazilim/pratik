...
export async function createModul(req, res) {
  ...
  try {
    ...
    const newModul = await connection.query(
      'INSERT INTO moduller ("modul_kodu", "modul_adi", "modul_aciklama", "kayit_yapan_kullanici") VALUES ($1, $2, $3, $4) RETURNING *',
      [modul_kodu, modul_adi, modul_aciklama, kayit_yapan_kullanici]
    );
